...
# PLEASE CHANGE THIS ACCORDING TO YOUR PATH
image_folder = './data'
...
class LabeledDataset(torch.utils.data.Dataset):    
    def __init__(self, image_folder, annotation_file, scene_index, transform, extra_info=True):
        ...
        Args:
            ...
            scene_index (list): a list of scene indices for the unlabeled data 
            transform (Transform): The function to process the image
            extra_info (Boolean): whether you want the exta information
        """
...
labeled_scene_index = np.arange(106,133)
unlabeled_scene_index = np.arange(0,105)
...
print(type(labeled_dataset.annotation_dataframe))

item = labeled_dataset.__getitem__(104)
print(item[0].shape) # 4 D return value